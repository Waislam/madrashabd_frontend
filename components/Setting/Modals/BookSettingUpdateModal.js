                            ...
                            <div className="row">
                                ...
                                <div className="mt-4">
                                    ...
                                    <select type="text" className="form-select"
                                        ...
                                        {...register("department")}
                                    >
                                        <option value={props.booksettingolddata?.department?.id}>{props.booksettingolddata?.department?.name}</option>
                                ...
                                <div className="my-4">
                                    ...
                                    >
                                        <option value={props.booksettingolddata?.madrasha_class?.id}>{props.booksettingolddata?.madrasha_class?.name}</option>
