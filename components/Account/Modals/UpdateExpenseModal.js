...
const modalpage = (props) => {
    // console.log("actual data shouldd be: ", typeof(props.individualExpenseData?.category.id))
                        ...
                        <div className="row">
                            <div className="col-md-4 mb-3">
                                <div className="form-group">
                                    ...
                                    >
                                        <option value={props.individualExpenseData?.category.id}>{props.individualExpenseData?.category.name}</option>
                            ...
                            <div className="col-md-4 mb-3">
                                <div className="form-group">
                                    ...
                                    >
                                        <option value={props.individualExpenseData?.sub_category.id}>{props.individualExpenseData?.sub_category.name}</option>
