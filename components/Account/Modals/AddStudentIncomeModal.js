...
const modalpage = ({ shown, close, incomeCategoryList, setTransactionCaterory, transactionSubCaterory, studentFees, madrasha_id }) => {
                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    <div className="row">
                                            ...
                                            <div className="form-group">
                                                ...
                                                >
                                                    {studentFees && studentFees.map((fees) => (
                                                        <option value={fees?.id} key={fees?.id}>{fees.amount}</option>
                                                    ))}
                                                </select>
                                        ...
                                        <div className="col-md-4 mb-3">
                                            <div className="form-group">
                                                <label className="mb-2">From Month</label>
                                                <select className="form-control form-select"
                                                    name="for_month"
                                                    {...register("for_month")}
                                                >
                                        ...
                                        <div className="col-md-4 mb-3">
                                            <div className="form-group">
                                                <label className="mb-2">To Month</label>
                                                <select className="form-control form-select"
                                                    name="to_month"
                                                    {...register("to_month")}
                                                >
