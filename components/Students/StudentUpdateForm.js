...
const StudentUpdateForm = ({ data, getDivision, districtList, getDistrict, thanaList, postOfficeList, getPostOffice, postCodeList,
    ...
    // console.log("studdent detailss: ",student?.present_address?.division?.name)
    ...
    const formDefaultValues = {
        ...
        monthly_tution_fee: student?.monthly_tution_fee,
        boarding_feee: student?.boarding_feee,
    ...
    const onSubmit = (data) => {
        ...
        const updatedData = {
            ...
            special_body_sign: data?.special_body_sign,
            academic_fees: null,
            monthly_tution_fee: data?.monthly_tution_fee,
            boarding_feee: data?.boarding_feee,
                ...
                <div className="card">
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="row">
                                    <div className="col-md-4 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student?.present_address?.division?.pk}>
                                                    {student?.present_address?.division?.name}
                                                </option>
                                                {
                                    ...
                                    <div className="col-md-4 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.present_address?.district?.pk}>
                                                    {student.present_address?.district?.name}
                                                </option>
                                                {
                                    ...
                                    <div className="col-md-4 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.present_address?.thana?.pk}>
                                                    {student.present_address?.thana?.name}
                                                </option>
                                                {
                                ...
                                <div className="row">
                                    <div className="col-md-6  mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.present_address?.post_office?.pk}>
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.present_address?.post_code?.pk}>
                                                    {student.present_address?.post_code?.pk}
                                                </option>
                                                {
                                ...
                                <div className="row">
                                    <div className="col-md-4 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.permanent_address?.division?.pk}>
                                                    {student.permanent_address?.division?.name}
                                                </option>
                                                {
                                                    divisionList && divisionList.map((division) => (
                                                        <option key={division.pk} value={division.pk}>
                                    ...
                                    <div className="col-md-4  mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.permanent_address?.district?.pk}>
                                                    {student.permanent_address?.district?.name}
                                                </option>
                                                {
                                    ...
                                    <div className="col-md-4 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.permanent_address?.thana?.pk}>
                                                    {student.permanent_address?.thana?.name}
                                                </option>
                                                {
                                ...
                                <div className="row">
                                    <div className="col-md-6 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.permanent_address?.post_office?.pk}>
                                                    {student.permanent_address?.post_office?.name}
                                                </option>
                                                {
                                    ...
                                    <div className="col-md-6 mb-4">
                                        <div>
                                            ...
                                            >
                                                <option value={student.permanent_address?.post_code?.pk}>
                                                    {student.permanent_address?.post_code?.name}
                                                </option>
                                                {
                            ...
                            {/*Academic Fees *******************************************/}
                            <div className="academic-fees my-5">
                                {/* <h4>Part E</h4> */}
                                <h5>Academic Fees</h5>
                                <div className="row mb-3">
                                    <div className="col-md-6">
