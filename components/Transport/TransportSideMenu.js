                ...
                <div className={styles.transportRightSide}>
                    <div className="card">
                        ...
                        <div className="card-body p-0">
                            <div
                                className={router.pathname == "/transport" ? `${styles.activeLink}` : `${styles.inActiveLink}`}>
                                <Link href="/transport">
                                    <a className="text-center">Transport Details</a>
                                </Link>
                            </div>
                            <div
                                className={router.pathname == "/transport/gari" ? `${styles.activeLink}` : `${styles.inActiveLink}`}>
