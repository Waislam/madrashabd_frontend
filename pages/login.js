                        ...
                        <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-4 mt-4">
                            <div className={styles.loginFormWrap}>
                                ...
                                <div className={styles.loginForm}>
                                    <form method="post" action="/api/auth/callback/credentials">
                                        <input name="csrfToken" type="hidden" defaultValue={csrfToken} />
                                        <input type="text" name="username" className="form-control mb-3 " placeholder="User Name"/>
                                        <input type="password" name="password" className="form-control mb-3" placeholder="User Password"/>
